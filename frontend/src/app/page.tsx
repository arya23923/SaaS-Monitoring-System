...
<section className="container py-20 border-t border-zinc-800" id="documention" >
  <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
    ...
    <div>
      ...
      <p className="text-zinc-400 mb-6 w-100">
    ...
    <div className="space-y-6">
      {/* Step 1 */}
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 w-95">
...
{`npm i saas-monitering-sdk`}
      ...
      {/* Step 3 */}
      <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 overflow-hidden w-95">
